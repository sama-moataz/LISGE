...
const preCollegeCourses: PreCollegeCourse[] = [
  ...
  {
    id: 'jhu-pre-college',
    name: 'Pre-College Summer Programs',
  ...
  },
  {
    ...
    name: 'Global Navigator High School Summer Abroad',
    institution: 'CIEE',
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="mt-2 text-lg text-muted-foreground">
          Get a taste of university life and academics with these preparatory courses.
        </p>
      </div>
        ...
        {preCollegeCourses.map((course) => (
          <Card key={course.id} className="flex flex-col hover:shadow-lg transition-shadow duration-300">
            <CardHeader>
              ...
              {course.category && <p className="text-sm text-accent-foreground bg-accent/20 px-2 py-1 rounded-full inline-block mt-1">{course.category} - {course.location}</p>}
