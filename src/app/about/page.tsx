    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="mt-2 text-lg text-muted-foreground">
          Learn more about the story and motivation behind LISGE Hub.
        </p>
      </div>
      ...
      <Card className="overflow-hidden shadow-lg">
        <CardHeader className="bg-primary/10 p-6">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="text-center md:text-left">
              <CardTitle className="text-3xl font-headline text-primary">Founder of LISGE Hub</CardTitle>
        ...
        <CardContent className="p-6 md:p-8 space-y-6 text-lg leading-relaxed text-foreground/90">
          <p>
            Hello! I'm the founder of LISGE Hub, and my journey has been one of dedication, learning, and a desire to give back. Growing up in Giza, Egypt, I always strived for excellence, both academically and in my extracurricular pursuits.
          </p>
          <p>
          ...
          <p>
            My motivation for creating LISGE Hub stems from my own experiences. I understand the challenges and opportunities that young students in Egypt face. I believe that with the right information and guidance, every student can achieve their dreams of leadership, secure international scholarships, and gain enriching global experiences. LISGE Hub is my way of sharing what I've learned and creating a supportive community for ambitious students.
          </p>
          <p>
            Thank you for visiting, and I hope LISGE Hub becomes a valuable resource on your journey!
          </p>
        </CardContent>
      </Card>
    </div>
