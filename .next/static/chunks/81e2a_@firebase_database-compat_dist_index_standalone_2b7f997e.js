...
"[project]/node_modules/firebase-admin/node_modules/@firebase/database-compat/dist/index.standalone.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var require$$2 = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/util/util.js [app-client] (ecmascript)");
var require$$0 = __turbopack_context__.r("[project]/node_modules/buffer/index.js [app-client] (ecmascript)");
var require$$1 = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/events/events.js [app-client] (ecmascript)");
var require$$0$1 = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/stream-browserify/index.js [app-client] (ecmascript)");
var require$$1$1 = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/crypto-browserify/index.js [app-client] (ecmascript)");
var require$$2$1 = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/native-url/index.js [app-client] (ecmascript)");
var require$$0$2 = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/assert/assert.js [app-client] (ecmascript)");
var require$$1$2 = (()=>{
...
var require$$1$3 = __turbopack_context__.r("[project]/node_modules/firebase-admin/node_modules/@firebase/util/dist/index.cjs.js [app-client] (ecmascript)");
var require$$2$3 = __turbopack_context__.r("[project]/node_modules/tslib/tslib.es6.mjs [app-client] (ecmascript)");
var require$$3 = __turbopack_context__.r("[project]/node_modules/firebase-admin/node_modules/@firebase/logger/dist/index.cjs.js [app-client] (ecmascript)");
var require$$4 = __turbopack_context__.r("[project]/node_modules/firebase-admin/node_modules/@firebase/component/dist/index.cjs.js [app-client] (ecmascript)");
...
/*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */ (function(module, exports1) {
    /* eslint-disable node/no-deprecated-api */ var buffer = require$$0__default["default"];
...
**/ var Stream$3 = require$$0__default$1["default"].Stream, util$c = require$$2__default["default"];
...
Headers$3.prototype.ALLOWED_DUPLICATES = [
    'set-cookie',
    'set-cookie2',
    'warning',
    'www-authenticate'
...
var Buffer$8 = safeBuffer.exports.Buffer, Emitter = require$$1__default["default"].EventEmitter, util$b = require$$2__default["default"], streams = streams$1, Headers$2 = headers, Reader = stream_reader;
var Base$7 = function(request, url, options) {
    Emitter.call(this);
    Base$7.validateOptions(options || {}, [
        'maxLength',
        'masking',
        'requireMasking',
        'protocols'
...
for(var key$b in instance$b)Base$7.prototype[key$b] = instance$b[key$b];
...
var base = Base$7;
var httpParser = {};
/*jshint node:true */ var assert = require$$0__default$2["default"];
...
var NodeHTTPParser = httpParser.HTTPParser, Buffer$7 = safeBuffer.exports.Buffer;
var TYPES = {
...
var VERSION = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].version ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].version.match(/[0-9]+/g).map(function(n) {
...
HttpParser$3.prototype.parse = function(chunk) {
    ...
    if (this._complete) this.body = consumed < chunk.length ? chunk.slice(consumed) : Buffer$7.alloc(0);
};
...
Pledge$2.all = function(list) {
    var pledge = new Pledge$2(), pending = list.length, n = pending;
...
var pledge = Pledge$2;
var Functor = functor, Pledge$1 = pledge;
...
var Parser = parser, Pipeline = pipeline;
...
for(var key$a in instance$a)Extensions$1.prototype[key$a] = instance$a[key$a];
...
for(var key$9 in instance$9)Frame$1.prototype[key$9] = instance$9[key$9];
var frame = Frame$1;
...
for(var key$8 in instance$8)Message$1.prototype[key$8] = instance$8[key$8];
var message = Message$1;
var Buffer$5 = safeBuffer.exports.Buffer, crypto$2 = require$$1__default$1["default"], util$a = require$$2__default["default"], Extensions = websocket_extensions, Base$6 = base, Frame = frame, Message = message;
...
var instance$7 = {
    ...
    _sendFrame: function(frame) {
        var length = frame.length, header = length <= 125 ? 2 : length <= 65535 ? 4 : 10, offset = header + (frame.masked ? 4 : 0), buffer = Buffer$5.allocUnsafe(offset + length), masked = frame.masked ? this.MASK : 0;
    ...
    _emitFrame: function(buffer) {
        var frame = this._frame, payload = frame.payload = Hybi$2.mask(buffer, frame.maskingKey), opcode = frame.opcode, message, code, reason, callbacks, callback;
        delete this._frame;
    ...
    _emitMessage: function(message) {
        ...
        this._extensions.processIncomingMessage(message, function(error, message) {
            ...
            else this.emit('message', new Base$6.MessageEvent(payload));
        }, this);
    },
...
for(var key$7 in instance$7)Hybi$2.prototype[key$7] = instance$7[key$7];
var hybi = Hybi$2;
var Buffer$4 = safeBuffer.exports.Buffer, Stream$2 = require$$0__default$1["default"].Stream, url$2 = require$$2__default$1["default"], util$9 = require$$2__default["default"], Base$5 = base, Headers$1 = headers, HttpParser$2 = http_parser;
var PORTS = {
    'ws:': 80,
    'wss:': 443
};
...
for(var key$6 in instance$6)Proxy$1.prototype[key$6] = instance$6[key$6];
var proxy = Proxy$1;
var Buffer$3 = safeBuffer.exports.Buffer, crypto$1 = require$$1__default$1["default"], url$1 = require$$2__default$1["default"], util$8 = require$$2__default["default"], HttpParser$1 = http_parser, Base$4 = base, Hybi$1 = hybi, Proxy = proxy;
...
for(var key$5 in instance$5)Client$2.prototype[key$5] = instance$5[key$5];
var client$1 = Client$2;
var Buffer$2 = safeBuffer.exports.Buffer, Base$3 = base, util$7 = require$$2__default["default"];
...
var instance$4 = {
    ...
    frame: function(buffer) {
        ...
        var length = Buffer$2.byteLength(buffer), frame = Buffer$2.allocUnsafe(length + 2);
        frame[0] = 0x00;
...
for(var key$4 in instance$4)Draft75$2.prototype[key$4] = instance$4[key$4];
var draft75 = Draft75$2;
var Buffer$1 = safeBuffer.exports.Buffer, Base$2 = base, Draft75$1 = draft75, crypto = require$$1__default$1["default"], util$6 = require$$2__default["default"];
...
var instance$3 = {
    ...
    close: function() {
        if (this.readyState === 3) return false;
        if (this.readyState === 1) this._write(Buffer$1.from([
            0xFF,
            0x00
        ]));
        this.readyState = 3;
...
for(var key$3 in instance$3)Draft76$1.prototype[key$3] = instance$3[key$3];
var draft76 = Draft76$1;
var util$5 = require$$2__default["default"], HttpParser = http_parser, Base$1 = base, Draft75 = draft75, Draft76 = draft76, Hybi = hybi;
...
for(var key$2 in instance$2)Server$1.prototype[key$2] = instance$2[key$2];
...
var Base = base, Client$1 = client$1, Server = server;
var Driver = {
...
var Stream$1 = require$$0__default$1["default"].Stream, util$4 = require$$2__default["default"], driver$3 = driver$4, EventTarget$1 = event_target, Event$1 = event;
var API$3 = function(options) {
    options = options || {};
    driver$3.validateOptions(options, [
        'headers',
        'extensions',
        'maxLength',
        'ping',
...
var instance$1 = {
    ...
    send: function(data) {
        ...
        if (!(data instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"])) data = String(data);
...
var api = API$3;
var util$3 = require$$2__default["default"], net = require$$1__default$2["default"], tls = require$$2__default$2["default"], url = require$$2__default$1["default"], driver$2 = driver$4, API$2 = api;
var DEFAULT_PORTS = {
    'http:': 80,
    'https:': 443,
    'ws:': 80,
...
var Client = function(_url, protocols, options) {
    options = options || {};
    this.url = _url;
    this._driver = driver$2.client(this.url, {
...
var client = Client;
var Stream = require$$0__default$1["default"].Stream, util$2 = require$$2__default["default"], driver$1 = driver$4, Headers = headers, API$1 = api, EventTarget = event_target, Event = event;
...
var util$1 = require$$2__default["default"], driver = driver$4, API = api;
...
Object.defineProperty(index_standalone, '__esModule', {
    value: true
});
...
var logWrapper = function(prefix) {
    return function() {
        ...
        log.apply(void 0, tslib.__spreadArray([
            prefix
        ], tslib.__read(varArgs), false));
    };
};
var error = function() {
    var varArgs = [];
     ...
     */ WebSocketConnection.prototype.open = function(onMessage, onDisconnect) {
        ...
        try {
            ...
            if (util.isNodeSdk()) {
                ...
                options = {
                    headers: {
                        'User-Agent': "Firebase/".concat(PROTOCOL_VERSION, "/").concat(SDK_VERSION, "/").concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].platform, "/").concat(device),
                ...
                var env = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]['env'];
 ...
 */ var AppCheckTokenProvider = function() {
    ...
    AppCheckTokenProvider.prototype.notifyForInvalidToken = function() {
        warn$1("Provided AppCheck credentials for the app named \"".concat(this.appName_, "\" ") + 'are invalid. This usually indicates your app was not initialized correctly.');
    };
 ...
 */ var LeafNode = function() {
    ...
    /** @inheritDoc */ LeafNode.prototype.isLeafNode = function() {
        return true;
    };
    /** @inheritDoc */ LeafNode.prototype.getPriority = function() {
        return this.priorityNode_;
    };
    /** @inheritDoc */ LeafNode.prototype.updatePriority = function(newPriorityNode) {
        return new LeafNode(this.value_, newPriorityNode);
    };
    /** @inheritDoc */ LeafNode.prototype.getImmediateChild = function(childName) {
    ...
    /** @inheritDoc */ LeafNode.prototype.getChild = function(path) {
        if (pathIsEmpty(path)) {
            return this;
    ...
    /** @inheritDoc */ LeafNode.prototype.getPredecessorChildName = function(childName, childNode) {
        return null;
    };
    /** @inheritDoc */ LeafNode.prototype.updateImmediateChild = function(childName, newChildNode) {
        if (childName === '.priority') {
    ...
    /** @inheritDoc */ LeafNode.prototype.updateChild = function(path, newChildNode) {
    ...
    /** @inheritDoc */ LeafNode.prototype.isEmpty = function() {
        return false;
    };
    /** @inheritDoc */ LeafNode.prototype.numChildren = function() {
        return 0;
    };
    /** @inheritDoc */ LeafNode.prototype.forEachChild = function(index, action) {
        return false;
    };
    ...
    /** @inheritDoc */ LeafNode.prototype.hash = function() {
 ...
 */ var ChildrenNode = function() {
    ...
    /** @inheritDoc */ ChildrenNode.prototype.isLeafNode = function() {
        return false;
    };
    /** @inheritDoc */ ChildrenNode.prototype.getPriority = function() {
        return this.priorityNode_ || EMPTY_NODE;
    };
    /** @inheritDoc */ ChildrenNode.prototype.updatePriority = function(newPriorityNode) {
        if (this.children_.isEmpty()) {
    ...
    /** @inheritDoc */ ChildrenNode.prototype.getImmediateChild = function(childName) {
        // Hack to treat priority as a regular child
        if (childName === '.priority') {
    ...
    /** @inheritDoc */ ChildrenNode.prototype.getChild = function(path) {
        var front = pathGetFront(path);
        if (front === null) {
            return this;
        }
    ...
    /** @inheritDoc */ ChildrenNode.prototype.hasChild = function(childName) {
        return this.children_.get(childName) !== null;
    };
    /** @inheritDoc */ ChildrenNode.prototype.updateImmediateChild = function(childName, newChildNode) {
    ...
    /** @inheritDoc */ ChildrenNode.prototype.updateChild = function(path, newChildNode) {
        var front = pathGetFront(path);
        if (front === null) {
            return newChildNode;
        } else {
    ...
    /** @inheritDoc */ ChildrenNode.prototype.isEmpty = function() {
        return this.children_.isEmpty();
    };
    /** @inheritDoc */ ChildrenNode.prototype.numChildren = function() {
        return this.children_.count();
    };
    /** @inheritDoc */ ChildrenNode.prototype.val = function(exportFormat) {
        if (this.isEmpty()) {
            return null;
        }
        var obj = {};
    ...
    /** @inheritDoc */ ChildrenNode.prototype.hash = function() {
        if (this.lazyHash_ === null) {
            var toHash_1 = '';
    ...
    /** @inheritDoc */ ChildrenNode.prototype.getPredecessorChildName = function(childName, childNode, index) {
        ...
        if (newSnap.isLeafNode() || newSnap.isEmpty()) {
            ...
            if (this.limit_ * 2 < newSnap.numChildren() && newSnap.isIndexed(this.index_)) {
                ...
                while(iterator.hasNext()){
                    var next = iterator.getNext();
                    var inRange = count < this.limit_ && this.withinDirectionalStart(next) && this.withinDirectionalEnd(next);
                    if (inRange) {
                        count++;
                    } else {
 ...
 */ var ReadonlyRestClient = function(_super) {
    ...
    /** @inheritDoc */ ReadonlyRestClient.prototype.listen = function(query, currentHashFn, tag, onComplete) {
        var _this = this;
        var pathString = query._path.toString();
    ...
    /** @inheritDoc */ ReadonlyRestClient.prototype.unlisten = function(query, tag) {
        var listenId = ReadonlyRestClient.getListenId_(query, tag);
    ...
    /** @inheritDoc */ ReadonlyRestClient.prototype.refreshAuthToken = function(token) {
                ...
                if (callback && xhr.readyState === 4) {
                    ...
                    if (xhr.status >= 200 && xhr.status < 300) {
                        try {
                            ...
                            warn$1('Failed to parse JSON response for ' + url + ': ' + xhr.responseText);
                        }
                        callback(null, res);
                    } else {
                        // 401 and 404 are expected.
                        if (xhr.status !== 401 && xhr.status !== 404) {
                            warn$1('Got unsuccessful REST response for ' + url + ' Status: ' + xhr.status);
                        }
                        callback(xhr.status);
                    }
                    callback = null;
 ...
 */ var ChildChangeAccumulator = function() {
    ...
    ChildChangeAccumulator.prototype.trackChildChange = function(change) {
        ...
        util.assert(type === "child_added" /* ChangeType.CHILD_ADDED */  || type === "child_changed" /* ChangeType.CHILD_CHANGED */  || type === "child_removed" /* ChangeType.CHILD_REMOVED */ , 'Only child changes supported for tracking');
 ...
 */ function repoSendReadyTransactions(repo, node) {
    ...
    if (treeGetValue(node)) {
        ...
        var allRun = queue.every(function(transaction) {
            return transaction.status === 0 /* TransactionStatus.RUN */ ;
        });
 ...
 */ var ReferenceImpl = function(_super) {
    ...
    /** @hideconstructor */ function ReferenceImpl(repo, path) {
 ...
 */ var Database$1 = function() {
    /** @hideconstructor */ function Database(_repoInternal, /** The {@link @firebase/app#FirebaseApp} associated with this Realtime Database instance. */ app) {
 ...
 */ function connectDatabaseEmulator(db, host, port, options) {
    ...
    if (repo.repoInfo_.nodeAdmin) {
        ...
        var token = typeof options.mockUserToken === 'string' ? options.mockUserToken : util.createMockUserToken(options.mockUserToken, db.app.options.projectId);
 ...
 */ function _initStandalone(_a) {
    ...
    if (customAppCheckImpl) {
        ...
        appCheckProvider.setComponent(new component.Component('app-check-internal', function() {
...
var Reference = function(_super) {
    ...
    /** @returns {?string} */ Reference.prototype.getKey = function() {
    ...
    /** @returns {?Reference} */ Reference.prototype.getParent = function() {
        require$$1$3.validateArgCount('Reference.parent', 0, 0, arguments.length);
        var parent = this._delegate.parent;
        return parent ? new Reference(this.database, parent) : null;
    };
    /** @returns {!Reference} */ Reference.prototype.getRoot = function() {
 ...
 */ function initStandalone$1(_a) {
    ...
    authProvider.setComponent(new require$$4.Component('auth-internal', function() {
        return customAuthImpl;
    }, "PRIVATE" /* ComponentType.PRIVATE */ ));
    var appCheckProvider = undefined;
    if (customAppCheckImpl) {
        appCheckProvider = new require$$4.Provider('app-check-internal', container);
        appCheckProvider.setComponent(new require$$4.Component('app-check-internal', function() {
            return customAppCheckImpl;
        }, "PRIVATE" /* ComponentType.PRIVATE */ ));
    }
    return {
...
exports.initStandalone = initStandalone; //# sourceMappingURL=index.standalone.js.map
}}),
}]);

//# sourceMappingURL=81e2a_%40firebase_database-compat_dist_index_standalone_2b7f997e.js.map