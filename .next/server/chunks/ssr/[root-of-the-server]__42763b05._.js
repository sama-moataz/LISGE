...
console.log("NEXT_PUBLIC_FIREBASE_API_KEY:", ("TURBOPACK compile-time truthy", 1) ? "Loaded" : ("TURBOPACK unreachable", undefined));
console.log("NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN:", ("TURBOPACK compile-time value", "lisge-hbsqy.firebaseapp.com"));
console.log("NEXT_PUBLIC_FIREBASE_PROJECT_ID:", ("TURBOPACK compile-time value", "lisge-hbsqy"));
// Initialize Firebase
let app;
if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApps"])().length) {
    try {
        ...
        console.error('Attempted Firebase Config (API Key Redacted):', JSON.stringify({
            ...firebaseConfig,
            apiKey: firebaseConfig.apiKey ? 'REDACTED' : 'MISSING/INVALID'
        }));
        throw error;
    }
} else {
...
const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__p__as__getAuth$3e$__["getAuth"])(app);
...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["auth"], async (currentUser)=>{
            ...
            if (currentUser) {
                ...
                try {
                    ...
                    if (userDocSnap.exists()) {
                        const profileData = userDocSnap.data(); // Assume UserProfile structure for now
...
//# sourceMappingURL=%5Broot-of-the-server%5D__42763b05._.js.map