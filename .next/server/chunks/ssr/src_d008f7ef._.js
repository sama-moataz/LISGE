...
"[project]/src/lib/firebaseAdmin.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
if (!admin.apps.length) {
    if (!serviceAccountPath) {
        console.warn('WARNING: GOOGLE_APPLICATION_CREDENTIALS environment variable is not set. ' + 'Firebase Admin SDK will try to initialize with default credentials, which might only work in specific Google Cloud environments. ' + 'For local development and most deployments, provide a service account JSON file path via this variable.');
        try {
            admin.initializeApp();
...
"[project]/src/lib/firestoreAdminService.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firebaseAdmin.ts [app-ssr] (ecmascript)");
(()=>{
...
async function addScholarshipAdmin(scholarshipData) {
    ...
    try {
        const scholarshipsRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDB"].collection(SCHOLARSHIPS_COLLECTION);
        const docRef = await scholarshipsRef.add(dataToSave); // Type assertion as Admin SDK types might differ slightly
...
async function updateScholarshipAdmin(id, scholarshipData) {
    ...
    try {
        const scholarshipDocRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDB"].collection(SCHOLARSHIPS_COLLECTION).doc(id);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestoreAdminService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firestoreAdminService.ts [app-ssr] (ecmascript)"); // Import Admin SDK service
...
async function handleAddScholarship(formData) {
    ...
    try {
        ...
        const scholarshipId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestoreAdminService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addScholarshipAdmin"])(processedData);
        ...
        return {
            success: false,
            error: err.message || "Failed to add scholarship via Admin SDK."
        };
    }
}
function NewScholarshipPage() {
    ...
    const onSubmit = async (data)=>{
        ...
        Object.keys(processedClientData).forEach((key)=>{
            if (processedClientData[key] === "_none_") {
                processedClientData[key] = null;
            }
            if (typeof processedClientData[key] === 'string' && processedClientData[key].trim() === '' && key !== 'name' && key !== 'description' && key !== 'eligibility' && key !== 'websiteUrl' && key !== 'location') {
        ...
        if (result.success) {
            ...
            toast({
                ...
                description: result.error || "Failed to add scholarship. Check console for details.",
                variant: "destructive"
            });
...
//# sourceMappingURL=src_d008f7ef._.js.map