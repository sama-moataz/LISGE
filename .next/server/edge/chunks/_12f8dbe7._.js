(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/_12f8dbe7._.js", {
...
"[project]/node_modules/@vercel/edge-config-fs/index.edge.js [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@vercel/edge-config/dist/index.js [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$edge$2d$config$2d$fs$2f$index$2e$edge$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@vercel/edge-config-fs/index.edge.js [middleware-edge] (ecmascript)");
;
// package.json
...
var readFileTraced = trace(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$edge$2d$config$2d$fs$2f$index$2e$edge$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["readFile"], {
    name: "readFile"
});
...
var createClient = trace(function createClient2(connectionString, options = {
    ...
    const shouldUseDevelopmentCache = !options.disableDevelopmentCache && ("TURBOPACK compile-time value", "development") === "development" && process.env.EDGE_CONFIG_DISABLE_DEVELOPMENT_SWR !== "1";
    ...
    const api = {
        ...
        getAll: trace(async function getAll2(keys, localOptions) {
            ...
            const search = Array.isArray(keys) ? new URLSearchParams(keys.filter((key)=>typeof key === "string" && !isEmptyKey(key)).map((key)=>[
                    "key",
                    key
                ])).toString() : null;
...
//# sourceMappingURL=_12f8dbe7._.js.map